...
乍看之下，这个问题与很多已有文献做的工作十分类似。高效地查找在欧氏距离（或者更一般 $L_p$）方面的最佳匹配，是被人广泛研究的最近邻度量空间搜索问题。在文本挖掘和信息检索领域中，余弦相似性方面最佳匹配的高效检索已有相应的研究。不过正如我们会在下一节中解释的那样，最大内积搜索不仅与上述问题不同，而且更加困难
...
\bibitem{1} R. Bayardo, Y. Ma, and R. Srikant. Scaling Up All
Pairs Similarity Search. In Proceedings of the 16th
Intl. Conf. on World Wide Web, 2007.
\bibitem{2} R. M. Bell and Y. Koren. Lessons from the Netflix
Prize Challenge. SIGKDD Explor. Newsl., 2007.
\bibitem{3} J. Bennett and S. Lanning. The Netflix Prize. In Proc.
KDD Cup and Workshop, 2007.
\bibitem{4} A. Beygelzimer, S. Kakade, and J. Langford. Cover
Trees for Nearest Neighbor. Proceedings of the 23rd
Intl. Conf. on Machine Learning, 2006.
\bibitem{5} C. L. Blake and C. J. Merz. UCI Machine Learning
Repository. http://archive.ics.uci.edu/ml/, 1998.
\bibitem{6} L. Cayton and S. Dasgupta. A Learning Framework
for Nearest Neighbor Search. Advances in Neural Info.
Proc. Systems 20, 2007.
\bibitem{7} M. S. Charikar. Similarity Estimation Techniques from
Rounding Algorithms. In Proceedings of the 34th
annual ACM Symp. on Theory of Comp., 2002.
\bibitem{8} P. Ciaccia and M. Patella. PAC Nearest Neighbor
Queries: Approximate and Controlled Search in
High-dimensional and Metric spaces. Proceedings of
16th Intl. Conf. on Data Engineering, 2000.
\bibitem{9} K. Clarkson. Nearest-neighbor Searching and Metric
Space Dimensions. Nearest-Neighbor Methods for
Learning and Vision: Theory and Practice, 2006.
\bibitem{10} S. Dasgupta and Y. Freund. Random projection trees
and low dimensional manifolds. In Proceedings of the
40th annual ACM Symp. on Theory of Comp., 2008.
\bibitem{11} S. C. Deerwester, S. T. Dumais, T. K. Landauer,
G. W. Furnas, and R. A. Harshman. Indexing by
Latent Semantic Analysis. Journal of the American
Society of Info. Science, 1990.
\bibitem{12} G. Dror, N. Koenigstein, Y. Koren, and M. Weimer.
